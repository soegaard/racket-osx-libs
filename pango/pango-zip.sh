...
ZIP=/tmp/pango-1.29.5.zip
DEVZIP=/tmp/pango-dev-1.29.5.zip
cd /Users/soegaard/BuildRacketLibs

mkdir -p share/doc/pango-1.29.5
cp -p /Users/soegaard/BuildRacketLibs/pango/COPYING share/doc/pango-1.29.5

mkdir -p share/doc/pango-dev-1.29.5
cp -p /Users/soegaard/BuildRacketLibs/pango/COPYING share/doc/pango-dev-1.29.5
...
zip -r $ZIP share/doc/pango-1.29.5
...
zip -r $DEVZIP share/doc/pango-dev-1.29.5
